 ...
 * DEX SDK
 */
export const FACTORY_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const JOE_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const MASTERCHEF_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const MASTERCHEF_V3_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const BAR_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const ZAP_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const MAKER_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const ROLL_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const BORINGHELPER_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const BORINGHELPER_MCV3_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const BORINGHELPER_BMCJ_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const BORINGTOKENSCANNER_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const BORINGDASHBOARD_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
  [ChainId.FUJI]: '0xD28be693a573a26f50195213613EC893Ad5c4460',
...
export const LOCKING_WRAPPER_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const FARMLENS_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
  [ChainId.FUJI]: '0x0000000000000000000000000000000000000000',
...
export const FARMLENSV2_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const ROCKET_JOE_TOKEN_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const LAUNCH_EVENT_LENS_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const ROCKET_JOE_STAKING_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const STABLE_JOE_STAKING_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const MONEY_MAKER_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
  [ChainId.FUJI]: '0x6De03a4221d325Edc9707CEdeff9C150e99d6eC5',
...
export const SJOE_REWARD_TOKEN: { [chainId in ChainId]: `0x${string}` } = {
...
export const VEJOE_STAKING_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const VEJOE_TOKEN_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const BOOSTED_MASTERCHEF_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const INIT_CODE_HASH: { [chainId in ChainId]: `0x${string}` } = {
...
export const UNITROLLER_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const JOELENS_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const JAVAX_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
...
export const MAXIMILLION_ADDRESS: { [chainId in ChainId]: `0x${string}` } = {
