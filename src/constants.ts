...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FUJI]: '0x4F6ED4305D1dA27b5D9982b16dD8f8c8a6360E6C',
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FUJI]: '0x2D7a076502A5c3b31b9722F92d31bf00cD0Ac6B6',
...
export const MONEY_MAKER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FUJI]: '0x5b57Fef4e7f82f6c57a7Aca851Bc8c02F9AD3Bc5',
...
export const SJOE_REWARD_TOKEN: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FUJI]: '0x0aB13301B9e20E26A850EE264A09D248D678c4d6',
...
export const VEJOE_STAKING_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FUJI]: '0xFA1A163Ce4069CDCBa67BFbb444839B715D40811',
...
export const VEJOE_TOKEN_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FUJI]: '0x5a00A25a85ee298b871168BcE3FCC22B101087D3',
...
export const BOOSTED_MASTERCHEF_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FUJI]: '0x25431a19250a8f5Bbbdee18E687C2c027966dC10',
